...
// 				if (this.activity._renderWrapper) {
// 					this.activity._renderWrapper.removeAsync();
// 				}
// 				super.handleUnlink();
// 			}
// 		}
...
// 			this._renderWrapper.render(view, callback);
// 		} else if (app.renderer) {
// 			this._renderWrapper = app.renderer.render(view, callback);
// 		}
// 		return this;
// 	}
